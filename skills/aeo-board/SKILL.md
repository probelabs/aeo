...
After the board, the post-run judge (`scripts/judge_run.py`) can extract vendors from every completed arm — including misses that only name an unlisted product — then `scripts/render_judge_html.py`. See [PLAYBOOK.md](../../PLAYBOOK.md) §12.
